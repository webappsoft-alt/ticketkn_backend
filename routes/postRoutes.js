...
router.get('/admin/event/payment/:id',[authMiddleware,admin], postController.getAdminPurchases);
...
router.put('/transfer/:userId/:purchaseId/:code',authMiddleware, postController.transferTickets);
