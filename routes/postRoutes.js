...
router.put('/ticket/scan/:userId/:eventId/:code',authMiddleware, postController.updatePurchaseScan);
router.get('/ticket/:userId/:eventId/:code',optionalAuth, postController.getPurchaseTicket);
